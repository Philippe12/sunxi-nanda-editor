...
#define  LOG_TAG    "AWSE.Native.script_bin"

#define  pr_err(...)  __android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)
#define  pr_info(...)  __android_log_print(ANDROID_LOG_INFO,LOG_TAG,__VA_ARGS__)

#ifdef DEBUG
#define pr_debug(...)  __android_log_print(ANDROID_LOG_DEBUG,LOG_TAG,__VA_ARGS__)
#else
#define pr_debug(...)
#endif
